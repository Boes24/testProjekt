...
public class DataService
{
    ...
    public DagligSkæv OpretDagligSkaev(int patientId, int laegemiddelId, Dosis[] doser, DateTime startDato, DateTime slutDato)
    {
        ...
        DagligSkæv ordination = new DagligSkæv(startDato, slutDato, laegemiddelX, doser);
        patientX.ordinationer.Add(ordination);
        db.SaveChanges();
        return ordination;
    }
	...
	public double GetAnbefaletDosisPerDøgn(int patientId, int laegemiddelId)
    {
        ...
        else if (patientX.vaegt > 125){
            return laegemiddelX.enhedPrKgPrDoegnTung * patientX.vaegt;
        }else {
            return laegemiddelX.enhedPrKgPrDoegnNormal * patientX.vaegt;
        }
    }
